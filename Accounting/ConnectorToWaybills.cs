...
namespace ORM
{
    ...
    {
        public override IEnumerable<Waybill> Create(Waybill waybill)
        {
        ...
        public override IEnumerable<Waybill> Delete(int id)
        {
            connection.Command.Parameters.Clear();
        ...
        public override IEnumerable<Waybill> Update(Waybill waybill)
        {
            connection.Command.Parameters.Clear();
